...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('urls', sa.Column('full_url', sa.VARCHAR(), autoincrement=False, nullable=True))
    op.add_column('urls', sa.Column('shortened_url', sa.VARCHAR(), autoincrement=False, nullable=True))
